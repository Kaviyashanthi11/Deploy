...
async function continueWithLoggedInSession(page) {
    try {
        ...
        await page.goto(
            'https://pm.officeally.com/pm/Appointments/ViewAppointments.aspx?Tab=A&View=d&Day=24&Month=9&Year=2025&ProviderID=&OfficeID=&StatusID=&TimeInterval=30&DailyMode=',
            { waitUntil: 'networkidle2', timeout: 60000 }
        );

        console.log('⌛ Filling login form...');
        await page.waitForSelector('input#username', { timeout: 15000 });
        await page.type('input#username', 'Selvakumar01', { delay: 50 });

        await page.waitForSelector('input#password', { timeout: 15000 });
        await page.type('input#password', 'Beinggood@2025', { delay: 50 });

        console.log('🖱️ Clicking Continue button...');
        await Promise.all([
            page.click('body > main > section > div > div > div > form > div.c9ba8b92e > button'),
            page.waitForNavigation({ waitUntil: 'networkidle2', timeout: 60000 })
        ]);

        console.log('✅ Login successful. Waiting for Patient Visits tab...');

        // Wait for Patient Visits tab
        await page.waitForSelector('#patient-visits_tab > span', {
            visible: true,
            timeout: 20000,
        });
        ...
        // Optionally wait until patient visit content loads
